        ...
        <div>
          ...
          {ethBalance === undefined
            ...
            {/* src={"/providers/"+ (localStorage.selected == undefined ? context.account : localStorage.selected.toLowerCase()) +".png"} */}
              ...
              deactivate();
            }} className={props.isHome == "false" ? "auto btn btn-egoras": " btn btn-egoras"}> Logout <FontAwesomeIcon icon={faSignOutAlt} /> </button></span>): (<button onClick={toggle}  className={props.isHome == "false" ? "auto btn btn-egoras": "btn btn-egoras"}> Connect <FontAwesomeIcon icon={faSignInAlt} /> </button>
            )}
